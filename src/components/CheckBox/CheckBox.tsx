...
export const CheckBox: React.FC<CheckBoxProps> = ({onChange, className='', ...props}) => {
    const inputCheckClass = cn('checkbox', `${className}`);

    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => onChange(e.currentTarget.checked);
